...
controller.api.messenger_profile.menu([
    {
        ...
        call_to_actions: [
            ...
            },
            {
                ...
                title: "Botkit Docs",
                url:
                    "https://github.com/howdyai/botkit/blob/master/readme-facebook.md",
                        ...
                        elements: [
                            {
                                ...
                                subtitle:
                                    "Soft white cotton t-shirt is back in style",
                                buttons: [
                                    {
                                        type: "web_url",
                                        url:
                                    ...
                                    },
                                    {
                                        type: "web_url",
                                        url:
                                            "https://petersapparel.parseapp.com/buy_item?item_id=100",
                                        title: "Buy Item"
                                    },
                                    {
                                        type: "postback",
                            ...
                            },
                            {
                                ...
                                subtitle:
                                    "Soft gray cotton t-shirt is back in style",
                                buttons: [
                                    {
                                        type: "web_url",
                                        url:
                                    ...
                                    },
                                    {
                                        type: "web_url",
                                        url:
                                            "https://petersapparel.parseapp.com/buy_item?item_id=101",
                                        title: "Buy Item"
                                    },
                                    {
                                        type: "postback",
        ...
        convo.on("end", function(convo) {
            if (convo.status == "completed") {
                ...
                controller.storage.users.get(message.user, function(err, user) {
                    ...
                    user.saveAmount = convo.extractResponse("saveAmount");
...
controller.hears(["what is my name", "who am i"], "message_received", function(
    bot,
    message
) {
    controller.storage.users.get(message.user, function(err, user) {
...
controller.hears(
    ...
    function(bot, message) {
        ...
        bot.reply(
            message,
            ":|] I am a bot. I have been running for " +
                uptime +
                " on " +
                hostname +
                "."
...
controller.hears(["tags"], "message_received", function(bot, message) {
    controller.api.tags.get_all(function(tags) {
        for (var i = 0; i < tags.data.length; i++) {
            bot.reply(
                message,
                tags.data[i].tag + ": " + tags.data[i].description
            );
        }
    });
});

controller.hears(["send tagged message"], "message_received", function(
    bot,
    message
) {
    var taggedMessage = {
